...
**Title:** IVDR – application of IVDR requirements to 'legacy devices' and devices placed on the market prior to 26 May 2022  
...
| Item | Status |
|------|--------|
| Original (EN) | ✅ `original/mdcg_2022-8_en.pdf` |
...
| File | Description |
|------|-------------|
| `original/mdcg_2022-8_en.pdf` | Original English document (PDF) |
| `translation/MDCG-2022-8.he.json` | Canonical bilingual translation (source of truth) |
| `translation/MDCG-2022-8.he.html` | Hebrew RTL rendering, generated from the JSON |
