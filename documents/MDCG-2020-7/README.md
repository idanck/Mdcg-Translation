...
**Title:** Guidance on PMCF plan template  
...
| Item | Status |
|------|--------|
| Original (EN) | ✅ `original/mdcg_2020-7_en.pdf` |
...
| File | Description |
|------|-------------|
| `original/mdcg_2020-7_en.pdf` | Original English document (PDF) |
| `translation/MDCG-2020-7.he.json` | Canonical bilingual translation (source of truth) |
| `translation/MDCG-2020-7.he.html` | Hebrew RTL rendering, generated from the JSON |
